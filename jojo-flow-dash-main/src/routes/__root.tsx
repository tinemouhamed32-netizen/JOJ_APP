...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JOJ Transport Dakar 2026" },
      {
        name: "description",
        content:
          "Plateforme de supervision intelligente des transports des Jeux Olympiques de la Jeunesse Dakar 2026.",
      },
      { name: "author", content: "JOJ Mobility" },
